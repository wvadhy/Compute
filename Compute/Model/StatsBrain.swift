...
struct StatsBrain {
    ...
    mutating func createPieChart() -> PieChartView {
        ...
        entries.append(ChartDataEntry(x: Double(Brain.shared.totalCorrect), y: Double(Brain.shared.totalCorrect)))
        entries.append(ChartDataEntry(x: Double(Brain.shared.totalCorrect) - Double(Brain.shared.totalCorrect),
                                      y: Double(Brain.shared.totalCorrect) - Double(Brain.shared.totalCorrect)))
